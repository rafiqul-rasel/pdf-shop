...
<head>
    ...
    <style>
        body{
            background-image:url("{{asset('img/login_bg.jpg')}}")!important;
...
<div class="register-box">
    <div class="card card-outline card-primary">
        <div class="card-header text-center">
            <a href="{{route("homepage")}}" class="h1"><b>{{env('APP_NAME',"ONLINE PDF LIBRARY")}}</b></a>
        </div>
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="row">
                    ...
                    <!-- /.col -->
                    <div class="col-4">
                        <button id="btn-register"  type="submit" class="btn btn-primary btn-block">Register</button>
                    </div>
                    <!-- /.col -->
                </div>
            </form>
