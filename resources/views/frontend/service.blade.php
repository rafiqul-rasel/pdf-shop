                                    ...
                                    <ul>
                                        <li class="col-sm-3">
                                            <div class="fact-item icon-ebooks">
                                                <div class="fact-icon">
                                                    <img src="{{asset('frontend/images/icon-ebooks.png')}}" alt="" />
                                                </div>
                                        ...
                                        <li class="col-sm-3">
                                            <div class="fact-item icon-eaudio">
                                                <div class="fact-icon">
                                                    <img src="{{asset('frontend/images/icon-eaudio.png')}}" alt="" />
                                                </div>
                                        ...
                                        <li class="col-sm-3">
                                            <div class="fact-item icon-magazine">
                                                <div class="fact-icon">
                                                    <img src="{{asset('frontend/images/icon-magazine.png')}}" alt="" />
                                                </div>
                                        ...
                                        <li class="col-sm-3">
                                            <div class="fact-item icon-videos">
                                                <div class="fact-icon">
                                                    <img src="{{asset('frontend/images/icon-videos.png')}}" alt="" />
                                                </div>
